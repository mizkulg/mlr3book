...
A complete list with links to the respective repository can be found on the \href{https://github.com/mlr-org/mlr3/wiki/Extension-Packages}{wiki page on extension packages}.
...
\begin{verbatim}
## WARN  [08:30:44.716] this is a warning from mlr3
\end{verbatim}
...
\begin{verbatim}
## {"level":300,"timestamp":"2020-08-07 08:30:44","logger":"mlr","caller":"eval","msg":"this is a warning from mlr3"}
\end{verbatim}
